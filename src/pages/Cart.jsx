          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between items-center">
              ...
              <button
                ...
                disabled={clearing}
                className="text-xs text-red-600 hover:text-red-800 tracking-wide disabled:opacity-50"
              >
            ...
            {cartItems.map((item) => (
              <div
                key={item.id}
                className="bg-white border border-gray-100 rounded-xl p-3 md:p-4 flex gap-3 md:gap-4 items-center hover:shadow-lg transition"
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-gray-500 text-xs mb-1">
                    {parseFloat(item.products?.price || 0).toFixed(2)} EGP
                  </p>
                  ...
                  <div className="flex items-center gap-3">
                    <div className="flex items-center border border-gray-200 rounded-full">
                      <button
                        ...
                        className="px-2.5 py-0.5 text-gray-600 hover:text-black text-sm"
                      >
                        -
                      </button>
                    ...
                    <button
                      ...
                      className="text-[10px] text-gray-400 hover:text-red-600 transition tracking-widest"
                    >
                      REMOVE
                    </button>
                  </div>
            ...
            <div className="border-t border-gray-200 pt-4 mt-4">
              ...
              <button
                ...
                className="w-full bg-black text-white py-3 rounded-full text-xs tracking-widest hover:bg-gray-800 transition"
              >
                PROCEED TO CHECKOUT
              </button>
            </div>
